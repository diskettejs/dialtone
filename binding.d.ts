 ...
 */
export type BytesBuffer = string | Uint8Array
 ...
 */
export type CongestionControl = 'drop' | 'block' | 'block_first'
 ...
 */
export type ConsolidationMode = 'auto' | 'none' | 'monotonic' | 'latest'
 ...
 */
export type Locality = 'any' | 'remote' | 'session_local'
...
export type ParametersLike = Record<string, string>
 ...
 * The default is `Data`.
 */
export type Priority = 'real_time' | 'interactive_high' | 'interactive_low' | 'data_high' | 'data' | 'data_low' | 'background'
 ...
 */
export type QueryTarget = 'best_matching' | 'all' | 'all_complete'
 ...
 */
export type Reliability = 'best_effort' | 'reliable'
 ...
 */
export type ReplyKeyExpr = 'any' | 'matching_query'
...
export type ReplyResult = ReplyResultSample | ReplyResultError
