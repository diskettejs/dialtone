...
/* eslint-disable */
export type DeferredJs = unknown
declare global {
...
export declare class Liveliness {
  ...
  get(keyExpr: KeyExprArg, options?: LivelinessGetOptions | undefined | null): Promise<Handler>
}
...
export declare class Querier {
  ...
  get(options?: QuerierGetOptions | undefined | null): Promise<Handler>
  matchingStatus(): Promise<MatchingStatus>
  matchingListener(options?: MatchingListenerOptions | undefined | null): Promise<MatchingListener>
  undeclare(): void
}
...
export declare class Stream {
  ...
  [globalThis.Symbol.asyncIterator](): globalThis.__NapiRsAsyncGenerator<Stream, DeferredJs, void, undefined>
}
