import type { Config } from './binding.js'
...
/**
 * Builds a {@link Config} from a typed config object, ready to pass to
 ...
 */
export declare function defineConfig(config?: ZenohConfig): Config
